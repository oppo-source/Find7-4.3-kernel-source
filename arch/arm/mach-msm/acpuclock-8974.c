...
/* shu.liu@Onlinerd.Driver, 2014/05/28  Add for increase L2 voltage 50mv for solving reboot random */
...
#else  
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  300000, PLL_0, 0,   0 }, LVL_LOW,  1000000, 0 },
	[1]  = { {  345600, HFPLL, 2,  36 }, LVL_LOW,  1000000, 1 },
	[2]  = { {  422400, HFPLL, 2,  44 }, LVL_LOW,  1000000, 2 },
	[3]  = { {  499200, HFPLL, 2,  52 }, LVL_LOW,  1000000, 3 },
	[4]  = { {  576000, HFPLL, 1,  30 }, LVL_LOW,  1000000, 4 },
	[5]  = { {  652800, HFPLL, 1,  34 }, LVL_NOM,  1000000, 4 },
	[6]  = { {  729600, HFPLL, 1,  38 }, LVL_NOM,  1000000, 4 },
	[7]  = { {  806400, HFPLL, 1,  42 }, LVL_NOM,  1000000, 4 },
	[8]  = { {  883200, HFPLL, 1,  46 }, LVL_NOM,  1000000, 5 },
	[9]  = { {  960000, HFPLL, 1,  50 }, LVL_NOM,  1000000, 5 },
	[10] = { { 1036800, HFPLL, 1,  54 }, LVL_NOM,  1000000, 5 },
	[11] = { { 1113600, HFPLL, 1,  58 }, LVL_HIGH, 1100000, 6 },
	[12] = { { 1190400, HFPLL, 1,  62 }, LVL_HIGH, 1100000, 6 },
	[13] = { { 1267200, HFPLL, 1,  66 }, LVL_HIGH, 1100000, 6 },
	[14] = { { 1344000, HFPLL, 1,  70 }, LVL_HIGH, 1100000, 6 },
	[15] = { { 1420800, HFPLL, 1,  74 }, LVL_HIGH, 1100000, 6 },
	[16] = { { 1497600, HFPLL, 1,  78 }, LVL_HIGH, 1100000, 6 },
	[17] = { { 1574400, HFPLL, 1,  82 }, LVL_HIGH, 1100000, 7 },
	[18] = { { 1651200, HFPLL, 1,  86 }, LVL_HIGH, 1100000, 7 },
	[19] = { { 1728000, HFPLL, 1,  90 }, LVL_HIGH, 1100000, 8 },
	{ }
};
#endif /*CONFIG_VENDOR_EDIT*/
...
#ifdef CONFIG_VENDOR_EDIT
/* shu.liu@Onlinerd.Driver, 2014/05/28    Add for increase cpu core voltage 50mv for solving reboot random */
...
#else 
static struct acpu_level pro_rev1_2p5g_pvs0[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  850000,  76 },
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  850000,  87 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  850000, 106 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  860000, 126 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  870000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  880000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  890000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  900000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  910000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  920000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  930000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  940000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  950000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  960000, 348 },
	{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  970000, 372 },
	{ 0, { 1420800, HFPLL, 1,  74 }, L2(15),  980000, 396 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  990000, 421 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  1000000, 446 },
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(17),  1015000, 473 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  1030000, 501 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18),  1045000, 529 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1060000, 558 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1075000, 588 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(19), 1090000, 617 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(19), 1105000, 649 },
	{ 0, { 2150400, HFPLL, 1, 112 }, L2(19), 1120000, 682 },
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(19), 1120000, 682 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(19), 1135000, 716 },
	{ 0, { 2342400, HFPLL, 1, 122 }, L2(19), 1150000, 751 },
	{ 0, { 2419200, HFPLL, 1, 126 }, L2(19), 1165000, 786 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(19), 1170000, 802 },
	{ 0, { 0 } }
};
...
static struct acpu_level pro_rev1_2p5g_pvs1[] __initdata = {
	...
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  850000,  87 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  850000, 106 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  850000, 126 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  860000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  870000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  880000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  890000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  900000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  910000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  920000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  930000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  940000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  950000, 348 },
	{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  960000, 372 },
	{ 0, { 1420800, HFPLL, 1,  74 }, L2(15),  970000, 396 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  980000, 421 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  990000, 446 },
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(17), 1005000, 473 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18), 1020000, 501 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18), 1035000, 529 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1050000, 558 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1065000, 588 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(19), 1080000, 617 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(19), 1095000, 649 },
	{ 0, { 2150400, HFPLL, 1, 112 }, L2(19), 1110000, 682 },
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(19), 1110000, 682 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(19), 1125000, 716 },
	{ 0, { 2342400, HFPLL, 1, 122 }, L2(19), 1140000, 751 },
	{ 0, { 2419200, HFPLL, 1, 126 }, L2(19), 1155000, 786 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(19), 1160000, 802 },
	{ 0, { 0 } }
};
...
static struct acpu_level pro_rev1_2p5g_pvs2[] __initdata = {
	...
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  850000, 106 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  850000, 126 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  850000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  860000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  870000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  880000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  890000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  900000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  910000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  920000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  930000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  940000, 348 },
	{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  950000, 372 },
	{ 0, { 1420800, HFPLL, 1,  74 }, L2(15),  960000, 396 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  970000, 421 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  980000, 446 },
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(17),  995000, 473 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18), 1010000, 501 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18), 1025000, 529 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1040000, 558 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1055000, 588 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(19), 1070000, 617 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(19), 1085000, 649 },
	{ 0, { 2150400, HFPLL, 1, 112 }, L2(19), 1100000, 682 },
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(19), 1100000, 682 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(19), 1115000, 716 },
	{ 0, { 2342400, HFPLL, 1, 122 }, L2(19), 1130000, 751 },
	{ 0, { 2419200, HFPLL, 1, 126 }, L2(19), 1145000, 786 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(19), 1150000, 802 },
	{ 0, { 0 } }
};
...
static struct acpu_level pro_rev1_2p5g_pvs3[] __initdata = {
	...
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  850000, 126 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  850000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  850000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  860000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  870000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  880000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  890000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  900000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  910000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  920000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  930000, 348 },
	{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  940000, 372 },
	{ 0, { 1420800, HFPLL, 1,  74 }, L2(15),  950000, 396 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  960000, 421 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  970000, 446 },
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(17),  985000, 473 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18), 1000000, 501 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18), 1015000, 529 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1030000, 558 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1045000, 588 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(19), 1060000, 617 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(19), 1075000, 649 },
	{ 0, { 2150400, HFPLL, 1, 112 }, L2(19), 1090000, 682 },
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(19), 1090000, 682 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(19), 1105000, 716 },
	{ 0, { 2342400, HFPLL, 1, 122 }, L2(19), 1120000, 751 },
	{ 0, { 2419200, HFPLL, 1, 126 }, L2(19), 1135000, 786 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(19), 1140000, 802 },
	{ 0, { 0 } }
};
...
static struct acpu_level pro_rev1_2p5g_pvs4[] __initdata = {
	...
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  850000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  850000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  850000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  860000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  870000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  880000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  890000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  900000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  910000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  920000, 348 },
	{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  930000, 372 },
	{ 0, { 1420800, HFPLL, 1,  74 }, L2(15),  940000, 396 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(16),  950000, 421 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(17),  960000, 446 },
	{ 0, { 1651200, HFPLL, 1,  86 }, L2(17),  975000, 473 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(18),  990000, 501 },
	{ 0, { 1804800, HFPLL, 1,  94 }, L2(18), 1005000, 529 },
	{ 0, { 1881600, HFPLL, 1,  98 }, L2(18), 1020000, 558 },
	{ 1, { 1958400, HFPLL, 1, 102 }, L2(19), 1035000, 588 },
	{ 0, { 2035200, HFPLL, 1, 106 }, L2(19), 1050000, 617 },
	{ 0, { 2112000, HFPLL, 1, 110 }, L2(19), 1065000, 649 },
	{ 0, { 2150400, HFPLL, 1, 112 }, L2(19), 1080000, 682 },
	{ 0, { 2188800, HFPLL, 1, 114 }, L2(19), 1080000, 682 },
	{ 1, { 2265600, HFPLL, 1, 118 }, L2(19), 1095000, 716 },
	{ 0, { 2342400, HFPLL, 1, 122 }, L2(19), 1110000, 751 },
	{ 0, { 2419200, HFPLL, 1, 126 }, L2(19), 1125000, 786 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(19), 1130000, 802 },
	{ 0, { 0 } }
};
...
static struct acpu_level pro_rev1_2p5g_pvs6[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  825000,  76 },
	{ 0, {  345600, HFPLL, 2,  36 },  L2(1),  825000,  87 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  825000, 106 },
	{ 0, {  499200, HFPLL, 2,  52 },  L2(2),  825000, 126 },
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  825000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  825000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  830000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  840000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  850000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  860000, 256 },
...
static struct acpu_level pro_rev1_2p5g_pvs7[] __initdata = {
	...
	{ 0, {  576000, HFPLL, 1,  30 },  L2(3),  825000, 147 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  825000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  825000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  830000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  840000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  850000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  860000, 278 },
...
static struct acpu_level pro_rev1_2p5g_pvs8[] __initdata = {
	...
	{ 1, {  652800, HFPLL, 1,  34 },  L2(3),  825000, 168 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  825000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  825000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  830000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  840000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  850000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  860000, 301 },
...
static struct acpu_level pro_rev1_2p5g_pvs9[] __initdata = {
	...
	{ 1, {  729600, HFPLL, 1,  38 },  L2(4),  825000, 189 },
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  825000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  825000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  830000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  840000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  850000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  860000, 324 },
...
static struct acpu_level pro_rev1_2p5g_pvs10[] __initdata = {
	...
	{ 0, {  806400, HFPLL, 1,  42 },  L2(4),  825000, 211 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  825000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  825000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  830000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  840000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  850000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  860000, 348 },
...
static struct acpu_level pro_rev1_2p5g_pvs11[] __initdata = {
	...
	{ 1, {  883200, HFPLL, 1,  46 },  L2(4),  825000, 233 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  825000, 256 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  825000, 278 },
	{ 0, { 1113600, HFPLL, 1,  58 }, L2(10),  830000, 301 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(10),  840000, 324 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(13),  850000, 348 },
	{ 0, { 1344000, HFPLL, 1,  70 }, L2(14),  860000, 372 },
